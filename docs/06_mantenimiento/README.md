...
Aplicación web para la **I.E. Virgen del Carmen (Huayucachi)** y contexto de tesis de Ingeniería de Sistemas: gestión académica de primaria, sesiones de ap| Admin | `admin@virgendelcarmen.edu.pe` | `Admin123*` |
rendizaje y módulos de apoyo con **inteligencia artificial** (simulación local + puntos de extensión a API externa).
